/** @defgroup md380 TYT MD-380 (U/V)
 * Device specific classes for TyT MD-390, both the VHF and UHF version.
 *
 * \image html md380.jpg "MD-380" width=200px
 * \image latex md380.jpg "MD-380" width=200px
 *
 * The TYT MD-380 is a decent VHF or UHF FM and DMR handheld radio.
...
/** Implements an USB interface to the TYT MD-380 VHF/UHF 5W DMR (Tier I&II) radio.
 *
 * The TYT MD-380 radio use the TyT typical DFU-style communication protocol
 * to read and write codeplugs onto the radio (see @c TyTRadio).
 *
 * @ingroup md380 */
class MD380 : public TyTRadio
{
  Q_OBJECT
...
public:
  ...
  MD380(TyTInterface *device=nullptr, const ErrorStack &err=ErrorStack(), QObject *parent=nullptr);
